...
plt.plot(memsiz, times)
plt.xlabel("Memory Replay Buffer Size")
plt.ylabel("Seconds")
plt.savefig("times" + '_fig.png')
plt.clf()

plt.plot(memsiz, means)
plt.xlabel("Memory Replay Buffer Size")
plt.ylabel("Mean Score")
plt.savefig("means" + '_fig.png')
plt.clf()

plt.plot(memsiz, bests)
plt.xlabel("Memory Replay Buffer Size")
plt.ylabel("Best Score")
plt.savefig("bests" + '_fig.png')
plt.clf()